...
const SponsorCard = (props) => {
  return (
    <a href={props.website} target='_blank' rel='noopener noreferrer'>
      <div className='flex items-center border-2 border-gray-300 justify-center w-full h-28 sm:h-36 lg:h-56 bg-white shadow-lg rounded-xl'>
        <img
          src={props.image}
  ...
  return (
    <div className='z-60 flex md:h-full'>
      <div
        ...
        className={`my-5 mx-5 h-full md:h-auto md:mx-auto md:my-auto rounded-xl shadow-lg pt-10 px-8 md:px-14 pb-10 font-sora md:w-5/6 lg:w-2/3 ${
          theme ? 'bg-jams_dark_blue text-white' : 'bg-white'
        }  border-4 border-jams_blue`}
      >
        <h2 className='text-2xl font-semibold mb-5 md:mb-8'>
          <span className='border-b-4 border-jams_blue'>CrowdStrike</span>
        </h2>
        <div className='text-sm md:text-base lg:text-lg'>
          <p className='leading-relaxed text-justify py-4'>
            CrowdStrike is a leading cybersecurity company protecting customers
            from all cyber threats by leveraging its Security Cloud to stop
            breaches. From its inception in 2011, CrowdStrike was created as a
            different kind of cybersecurity company. Cloud-native, CrowdStrike
            immediately brought a threat perspective, effectiveness,
            scalability, and flexibility never seen before in the industry –
            seamlessly aligning People, Technology, and Processes. And it
            doesn’t stop there.
          </p>
          <p className='leading-relaxed text-justify py-4'>
            At CrowdStrike we’re on a mission - to stop breaches. Our ground
            breaking technology, services delivery, and intelligence gathering
            together with our innovations in machine learning and
            behavioural-based detection, allow our customers to not only defend
            themselves, but do so in a future-proof manner. Because of that
            we’ve earned numerous honours and top rankings for our technology,
            organization and talent. Our culture was purpose-built to be remote
            first, and we offer flexible work arrangements to help our people
            manage their personal and professional lives in a way that works for
            them.
          </p>
          <p className='leading-relaxed text-justify py-4'>
            If you’re ready to work on unrivalled technology with a team that
            makes a difference every day, let’s talk!
          </p>
        </div>
        <div className='flex flex-col md:flex-row justify-evenly'>
          <a
            ...
            className='bg-jams_blue rounded-md text-sm md:text-base px-6 mb-3 md:mb-0 text-center lg:px-12 py-3 font-semibold text-white'
          >
            Read More
          </a>
          <a
            ...
            className='bg-jams_blue rounded-md text-sm md:text-base px-6 text-center lg:px-12 py-3 font-semibold text-white'
          >
            Careers
          </a>
        </div>
  ...
  return (
    <div className='z-60 flex md:h-full'>
      <div
        ...
        className={`my-5 mx-5 h-full md:h-auto md:mx-auto md:my-auto rounded-xl shadow-lg pt-10 md:pt-14 px-8 md:px-14 pb-10 lg:pb-14 font-sora md:w-5/6 lg:w-2/3 ${
          theme ? 'bg-jams_dark_blue text-white' : 'bg-white'
        } border-4 border-jams_blue`}
      >
        <h2 className='text-2xl font-semibold mb-5 md:mb-8'>
        ...
        <div className='text-sm md:text-base lg:text-lg'>
          ...
          <p className='leading-relaxed text-justify py-4'>
            Groww is on a mission to democratize access to financial services
            for millions of Indians responsibly. We are a customer-first
            company.
          </p>
          <p className='leading-relaxed text-justify py-4'>
            We believe in crafting the best and most delightful user experience
            for our customers. And we leverage first principle thinking and
            technology to solve problems at scale. If this excites you, join us.
          </p>
        </div>
...
export default function Sponsors (props) {
  const [crowdstrikeInfoModalOpen, setCrowdstrikeInfoModalOpen] =
    useState(false)
          ...
          <div className='fixed top-0 left-0 z-50 flex h-full w-screen overflow-y-auto  transition-all ease-in-out duration-500'>
            <div
              className={`absolute opacity-70 z-50 ${
                props.darkTheme ? 'bg-gray-400' : 'bg-black'
              } h-screen w-full`}
            />
            <div className='z-50 h-screen overflow-y-auto m-auto'>
              <CrowdstrikeInfoModal
                theme={props.darkTheme}
                crowdstrikeInfoModalRef={crowdstrikeInfoModalRef}
              />
            </div>
          </div>
        )}
        {growwInfoModalOpen && (
          <div className='fixed top-0 left-0 z-50 flex h-full w-screen overflow-y-auto  transition-all ease-in-out duration-500'>
            ...
            <div className='z-50 h-screen overflow-y-auto m-auto'>
              <GrowwInfoModal
                theme={props.darkTheme}
                growwInfoModalRef={growwInfoModalRef}
              />
            </div>
          </div>
        )}

        {/* Don't change bg color of cards to gray-100 */}
            ...
            <div className='text-center'>
              ...
              <div className='grid gap-8 sm:gap-12 grid-cols-1 md:grid-cols-2 xl:grid-cols-6 mb-14 md:mb-20'>
                ...
                >
                  <img
                    src={Groww}
                    className='w-32 sm:w-36 lg:w-60 h-auto mx-3'
                    alt='CrowdStrike'
                  />
                </div>
