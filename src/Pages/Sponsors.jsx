...
const SponsorCard = (props) => {
  return (
    <a href={props.website} target='_blank' rel='noopener noreferrer'>
      <div className='flex items-center justify-center w-full h-28 sm:h-36 lg:h-56 bg-gray-50 shadow-lg rounded-xl'>
        <img
          src={props.image}
  ...
  return (
    <div className='absolute'>
      ...
      <div className='flex w-screen' ref={contentRef}>
        <div className='m-auto z-20 font-sora xl:w-5/6'>
          {/* grid gap-8 sm:gap-12 grid-cols-2 md:grid-cols-3 xl:grid-cols-4  */}
          <div className='sm:pb-16 md:pb-10 pt-24 md:pt-28'>
            ...
            <div className='grid gap-8 sm:gap-12 grid-cols-1 md:grid-cols-3 mb-10'>
              <div className='md:col-start-2 mx-12 md:mx-0'>
