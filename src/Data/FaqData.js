const faq = [
  ...
  {
    key: 2,
    question: 'What is DevTalks?',
    answer: 'DevTalks is a one-of-its-kind conference featuring notable professionals from various industries in a bidirectional setting where participants can interact, raise questions, and experts can share their insights with participants. With inspiring journeys and insightful stories, this event aims to inspire young developers and designers to learn from the best in the industry.',
    color: 'blue'
  },
  {
    key: 3,
  ...
  },
  {
    ...
    answer: 'The details for registering for DevJams will be released soon. Stay Tuned!',
    color: 'green'
  },
  {
    key: 5,
    question: 'Do I need to pay anything to register for DevTalks or DevJams?',
    answer: 'Like all our other events, DevTalks and DevJams, both are free-of-cost and you don’t need to pay anything to register for it. We plan to keep all of our future events free too.',
    color: 'yellow'
  },
  {
    key: 6,
    question: 'Which platform will be used to host DevTalks?',
    answer: 'DevTalks will be hosted as an online event on Airmeet. The link to the event will only be sent to the registered participants.',
    color: 'blue'
  },
  {
    key: 7,
  ...
  {
    key: 8,
    question: 'Will there be an interactive session between the speaker and the participants?',
    answer: 'Yes. After each speaker session, the participants will be allowed to ask questions and interact with the speaker.',
    color: 'green'
  },
  {
    key: 9,
