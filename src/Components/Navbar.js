      ...
      </div>
      {
        !startAnimation &&
          <div>
            ...
            <div
              className='absolute top-8 right-8 cursor-pointer z-30 px-9 py-2 rounded-md text-yellow-300 border-solid text-lg font-bold font-sora border-2 border-yellow-300 2xl:text-xl hover:bg-yellow-300 hover:text-indigo-700 transition-all duration-300 ease-in-out'
            >
              Login
            </div>
